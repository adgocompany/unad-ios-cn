#
#  Be sure to run `pod spec lint UNAD-ios-cn.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  这个是UNAD国内版本.的cocoapods
                   DESC

  spec.homepage     = "https://github.com/adgocompany/unad-ios-cn"
  ...
  spec.author             = { "UNAD" => "adgo@gmail.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/adgocompany/unad-ios-cn.git", :tag => "#{spec.version}" }
  ...
  #spec.source_files  = "Classes", "UNAD-ios-cn/ADP.framework/Headers/*.{h,m}"
  spec.exclude_files = "Classes/Exclude"

  # SDK的路径 写上库的位置 (自动生成没有这一项，不写会出错)
  spec.vendored_frameworks = 'UNAD-Cn/UNAD.framework'
  ...
  #
   ...
   spec.resource  = "UNAD-Cn/UNADBundle.bundle"
